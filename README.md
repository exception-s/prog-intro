 ...
 * *Base*
    * Класс `ExpressionParser` должен реализовывать интерфейс
        [TripleParser](java/exceptions/TripleParser.java)
 * *Zeroes* (32, 33)
 ...
 * *Base*
    * Класс `ExpressionParser` должен реализовывать интерфейс
        [TripleParser](../HW/Expressions/expression/parser/TripleParser.java)
    * Результат разбора должен реализовывать интерфейс
        [TripleExpression](java/expression/TripleExpression.java)
    * [Исходный код тестов](../HW/Expressions/expression/parser/ParserTest.java)
...
* [Базовые классы](../HW/Expressions/base/)
